/**
 * The FarmerController file is a very simple one, which does not need to be changed manually,
...
const farmerIdPUT = async (request, response) => {
  await Controller.handleRequest(request, response, service.farmerIdPUT);
};
