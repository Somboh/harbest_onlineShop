      ...
      <View style={[styles.container, { backgroundColor: display.background }]}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: display.text }]}>Frutas</Text>
          ...
          {/* HERO DE CATEGORÍA */}
          <View style={[styles.heroCard, { backgroundColor: settings.highContrast ? display.surface : '#f1c7c7', borderColor: display.border }]}>
            <View style={styles.heroContent}>
              <View style={[styles.heroBadge, { backgroundColor: display.primary }]}>
                <Ionicons name="nutrition" size={14} color={settings.highContrast ? '#000' : '#fff'} />
          ...
          {searchOpen ? (
            <View style={[styles.searchBox, { backgroundColor: display.surface, borderColor: display.border }]}>
              <Ionicons name="search-outline" size={18} color={display.textSoft} />
              <TextInput
                value={searchText}
          ...
          {loading && products.length === 0 ? (
            ...
            <View style={[styles.emptyState, { backgroundColor: display.surface, borderColor: display.border }]}>
              <Ionicons name="search-outline" size={28} color={display.primary} />
              <Text style={[styles.emptyTitle, { color: display.text }]}>No hay frutas con ese nombre</Text>
              <Text style={[styles.emptySubtitle, { color: display.textSoft }]}>
