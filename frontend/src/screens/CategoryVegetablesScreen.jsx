  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error('Error cargando productos de Verduras:', err);
      ...
      <View style={[styles.container, { backgroundColor: display.background }]}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: display.text }]}>Verduras</Text>
          ...
          {/* HERO DE CATEGORÍA */}
          <View style={[styles.heroCard, { backgroundColor: settings.highContrast ? display.surface : '#dbf1c7', borderColor: display.border }]}>
            <View style={styles.heroContent}>
              <View style={[styles.heroBadge, { backgroundColor: display.primary }]}>
                <Ionicons name="leaf" size={14} color={settings.highContrast ? '#000' : '#fff'} />
