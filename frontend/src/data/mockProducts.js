const products = [
  {
    ...
    description:
      "Naranjas de cultivo ecológico, jugosas y con sabor natural intenso. Recolectadas directamente del productor para garantizar frescura y comercio justo.",
  ...
  },
  {
    ...
    location: "Xativa",
    deliveryTime: "Entrega rápida",
    image: require("../../assets/images/comida/tomates.jpg"),
    featured: true,
    stock: 56,
  },
  {
